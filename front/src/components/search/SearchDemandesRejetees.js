...
export default class SearchDemandesRejetees extends Component {
  ...
  handleSubmit = (event) => {
    ...
    if (this.state.motifRejet !== "Tout afficher") {
      this.ref_motifs_rejet.forEach((e) => {
        if (this.state.motifRejet === e.libelleLong) {
          data.motifRejetId = e.motifRejetId;
        }
      });
    }
      ...
      <>
        ...
        <form className="form" onSubmit={this.handleSubmit}>
          ...
          <Row>
            ...
            <Col xs={12} sm={4}>
              <FormGroup>
                <ControlLabel>MOTIF DE REJET</ControlLabel>
                <FormControl
                  componentClass="select"
                ...
                >
                  ...
                  {this.ref_motifs_rejet != null &&
                    this.ref_motifs_rejet.map((m, index) => (
                      <option key={index}>{m.libelleLong}</option>
                    ))}
                </FormControl>
              </FormGroup>
